...
const defaultImpactData = [
  ...
  { title: 'Communities Reached', number: 6, description: 'Across different Northeast states in Nigeria.', link: '/communities' },
  { title: 'Partnerships', number: 5, description: 'With organizations committed to Deaf inclusion.', link: '/partnerships' }
];
